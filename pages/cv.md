...
在招聘平台工作期间，负责三大业务线：店长直聘、BOSS直聘、蓝领交付。这些业务线的核心目标是通过智能推荐系统提升用户的招聘和求职体验。为了实现这一目标，主导了标签体系、样本数据、特征工程、数据分析、推荐系统、监控体系等多个方面的工作。 主要任务是设计和优化三大业务线的推荐系统，包括召回、粗排、精排、重排等各个环节的推荐算法。此外，还负责样本体系、特征工程、数据挖掘、商业增长等方面。
